    ...
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Clients != null ? 
                          ...
                          Problem("Entity set 'ClientDbContext.Clients'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Ville")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Ville")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
